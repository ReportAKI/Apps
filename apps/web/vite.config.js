...
const configreportakiViteErrorHandler = `
...
const configreportakiRuntimeErrorHandler = `
...
if (window.navigation && window.self !== window.top) {
	window.navigation.addEventListener('navigate', (event) => {
		...
		window.parent.postMessage({
			type: 'reportaki-navigation-error',
			url,
		}, '*');
	});
}
		...
		const tags = [
			{
				tag: 'script',
				attrs: { type: 'module' },
				children: configreportakiRuntimeErrorHandler,
				injectTo: 'head',
			},
			{
				tag: 'script',
				attrs: { type: 'module' },
				children: configreportakiViteErrorHandler,
				injectTo: 'head',
			},
			{
				tag: 'script',
				attrs: { type: 'module' },
				children: configreportakiConsoleErrorHandler,
				injectTo: 'head',
			},
			{
				tag: 'script',
